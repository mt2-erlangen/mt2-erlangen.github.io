...
- Beschreibung der Implementierung *7P*
    - Beschreibung der Implementierung. *2P*
...
This part of the project work should be not longer than ~~1.5 pages~~. **After some remarks from you: 2 pages are also ok.**.
