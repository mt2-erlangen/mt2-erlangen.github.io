...
You can check the correctness of `atIndex` with the `ImageTest`in the file [`src/test/java/ImageTests.java`](https://github.com/mt2-erlangen/exercises-ss2021/blob/master/src/test/java/lme/ImageTests.java). 
